...
SECTION_HEADERS = ("错因", "讲解", "核心知识点", "练习题")
...
材料确认相关时才继续，按顺序完成以下四步，每一步用对应的方括号标题另起一行，
    ...
    try:
        ...
        with OpenAI(
            ...
            response = client.chat.completions.create(
                ...
                # 四段式输出比原来只出一道题长得多；deepseek-flash 等带隐藏
